...
class ChatService {
  ...
  Future<ChatConversation> community() async {
    final response = await ApiClient.dio.get('/chat/community');
    return ChatConversation.fromJson(
      Map<String, dynamic>.from(response.data['conversation']),
    );
  }

  Future<ChatConversation> startDirect(int userId) async {
    final response = await ApiClient.dio.post('/chat/direct/$userId');
    return ChatConversation.fromJson(Map<String, dynamic>.from(response.data));
  }
  ...
  Future<ChatMessage> edit(int conversationId, int messageId, String content) async {
  ...
  Future<ChatMessage> delete(int conversationId, int messageId) async {
